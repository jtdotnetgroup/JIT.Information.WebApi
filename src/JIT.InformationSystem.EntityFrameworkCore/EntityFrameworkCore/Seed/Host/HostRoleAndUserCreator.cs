...
namespace JIT.InformationSystem.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly InformationSystemDbContext _context;

        public HostRoleAndUserCreator(InformationSystemDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new InformationSystemAuthorizationProvider())
