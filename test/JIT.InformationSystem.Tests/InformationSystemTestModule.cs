...
namespace JIT.InformationSystem.Tests
{
    ...
    {
        public InformationSystemTestModule(InformationSystemEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<InformationSystemDbContext>>();
